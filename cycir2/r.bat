...
@REM cycir-api -dbuser='postgres' -dbpass='qwerqwer' -esAddress="http://localhost:9200" -esUsername="elastic" -esPassword="jHt1swMPzkAHttVEJ3si" -esIndex="cycir" -pusherHost="localhost" -pusherPort="4001" -pusherSecret="123abc" -pusherKey="abc123" -pusherSecure=false -pusherApp="1" -db="temp"